//import { markComplete } from "../controllers/teacherControllers.js";
import { ErrorHandler } from "../middleware/error.js";
import { Project } from "../models/project.js";
export const getProjectByStudent = async (studentId) => {
  return await Project.findOne({ student: studentId }).sort({ created: -1 });
};
...
export const addFeedback = async (
  ...
  const project = await Project.findById(projectId);
  if (!project) return new ErrorHandler("Project not found", 404);
